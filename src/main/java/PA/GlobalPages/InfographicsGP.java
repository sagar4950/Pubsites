...
public class InfographicsGP extends TestBase {

	public InfographicsGP() {
...
//	WebElement Readmore;
	...
	public void resourcemenuclick() {
		...
		//driver.get("https://abm.report/resources/infographics");
		String url = driver.getCurrentUrl();
		String newurl = url + "resources/infographics";
		driver.get(newurl);
